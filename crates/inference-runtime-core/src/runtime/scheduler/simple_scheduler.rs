    ...
    B: Batcher<UserReq, DeviceReq, DeviceResp>,
{
    ...
    pub fn swap_in(&mut self, user_req: UserReq) {
    ...
    pub fn prepare<BatchDeviceReq>(&mut self) -> BatchDeviceReq
    where
    ...
    pub fn cancel<BatchDeviceReq>(&mut self, batch_dev_req: BatchDeviceReq)
    where
        BatchDeviceReq: BatchDevReq<DeviceReq>,
    {
        let mut compute_slot = self
    ...
    pub fn commit<BatchDeviceResp>(&mut self, batch_dev_resp: BatchDeviceResp)
    where
...
mod tests {
    ...
    fn test_can_flush_tracks_runnable_work_and_compute_slot() {
        ...
        let batch_dev_req: TestBatchDevReq = scheduler.prepare();
