...
impl Config {
    ...
    fn qkv_dim(self) -> usize {
        2 * self.num_qk_heads as usize * self.qk_head_dim as usize
            + self.num_v_heads as usize * self.v_head_dim as usize
    }
...
impl Operator for Invocation<'_> {
    fn record(self, recorder: &CommandRecorder<'_>) {
        ...
        self.dispatch(recorder, config.recurrent_state_values());
