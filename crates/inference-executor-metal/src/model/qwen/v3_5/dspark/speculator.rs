...
impl Qwen35DSparkSpeculator {
    pub fn load(
        ...
        let kv_token_tile_size = plan.layers[0].attention_metal.single_q_token_kv_token_tile_size;
...
fn assert_layer_scratch_compatible(
    ...
    assert_eq!(
        first.attention_metal.single_q_token_kv_token_tile_size,
        other.attention_metal.single_q_token_kv_token_tile_size
    );
}
