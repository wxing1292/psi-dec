...
impl Qwen35DSparkLayer {
    pub fn load(
        ...
        Ok(Self {
            ...
            kv_token_tile_size: attention.single_q_token_kv_token_tile_size,
            sdpa_map_threads: attention.single_q_token_num_threads_per_threadblock,
            max_q_head_tile_size: attention.single_q_token_max_q_head_tile_size,
            ...
            local_sdpa: GQALocalSDPAKernel::new(
                ...
                GQALocalSDPAConfig {
                    ...
                    num_threads_per_threadblock: attention.single_q_token_num_threads_per_threadblock,
