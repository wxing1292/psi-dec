...
impl Qwen3xDSparkEmbed {
    ...
    pub fn replay_arguments(&self, key: &Qwen3xDSparkEmbedReplayKey) -> ReplayArguments {
        ReplayArguments::new().with_u32(DSPARK_EMBED_NUM_ACTIVE_TOKENS, key.num_total_tokens)
    }
}
